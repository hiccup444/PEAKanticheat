...
namespace AntiCheatMod
{
    ...
    public static class DetectionManager
    {
        ...
        {
            // Set default settings for each detection type
            SetDetectionSettings(DetectionType.CherryMod, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.AtlasMod, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.SteamNameMismatch, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.NameImpersonation, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.MidGameNameChange, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.SteamIDSpoofing, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.OwnershipTheft, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedDestroy, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.RateLimitExceeded, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedKill, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedRevive, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedWarp, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedStatusEffect, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedMovement, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedEmote, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedItemDrop, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedCampfireModification, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedFlareLighting, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.UnauthorizedBananaSlip, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.ItemSpawning, 
                new DetectionSettings(true, false, true, true)); // Warn by default, don't auto-block
            SetDetectionSettings(DetectionType.MasterClientTheft, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.InfinityWarp, 
                new DetectionSettings(true, true, true, true));
            SetDetectionSettings(DetectionType.PrefabDetection, 
                new DetectionSettings(true, false, true, true)); // Warn by default, don't auto-block
        }
