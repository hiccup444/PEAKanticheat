    ...
    public class AntiCheatUI : MonoBehaviour, IInRoomCallbacks
    {
        ...
        private string GetDetectionLabel(DetectionType type)
        {
            switch (type)
            {
                ...
                case DetectionType.PrefabDetection: return TranslationManager.GetTranslation("DETECTION_PREFAB_DETECTION");
                case DetectionType.ItemSpawning: return TranslationManager.GetTranslation("DETECTION_ITEM_SPAWNING");
